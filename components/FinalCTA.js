...
export default function FinalCTASection() {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative py-12 sm:py-16 lg:py-20 bg-gradient-to-b from-orange-50 to-white overflow-hidden mb-10"
    >
      {/* Gradient glows for depth */}
      <div
        ref={glow1Ref}
        className="absolute -top-20 sm:-top-40 -right-20 sm:-right-40 w-[300px] sm:w-[500px] h-[300px] sm:h-[500px] bg-orange-500/40 blur-3xl rounded-full pointer-events-none"
      />
      <div
        ref={glow2Ref}
        className="absolute -bottom-20 sm:-bottom-40 -left-20 sm:-left-40 w-[300px] sm:w-[500px] h-[300px] sm:h-[500px] bg-orange-400/30 blur-3xl rounded-full pointer-events-none"
      />
      ...
      <div className="relative container mx-auto px-4 sm:px-6 lg:px-8 text-center max-w-4xl">
        <h2
          ref={headingRef}
          className="text-3xl sm:text-4xl lg:text-5xl font-bold bg-gradient-to-r from-orange-600 to-orange-400 bg-clip-text text-transparent leading-tight px-2"
        >
          You don't need five vendors — you just need{" "}
          <span className="text-orange-600">Startup Builder</span>.
        </h2>
        ...
        >
          ...
          <span className="font-semibold text-orange-600">Startup Bank</span>{" "}
