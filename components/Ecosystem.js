  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-10 left-1/4 w-96 h-96 bg-purple-400 rounded-full blur-3xl opacity-20 animate-pulse"></div>
        <div className="absolute bottom-10 right-1/4 w-96 h-96 bg-pink-300 rounded-full blur-3xl opacity-20 animate-pulse" style={{ animationDelay: '1s' }}></div>
      </div>
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          <div className="inline-flex items-center gap-2 bg-purple-100 border border-purple-200 rounded-full px-4 sm:px-6 py-2 mb-4 sm:mb-6">
            <Sparkles className="text-purple-600 w-4 h-4" />
            <span className="text-purple-700 text-xs sm:text-sm font-semibold uppercase tracking-wider">
              Our Ecosystem
            </span>
          </div>
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-4 sm:mb-6 leading-tight px-4">
            A Group of{" "}
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-500 via-pink-400 to-blue-500">
              Powerhouse Partners
            </span>
          ...
          <p className="text-gray-700 text-sm sm:text-base md:text-lg lg:text-xl max-w-3xl mx-auto leading-relaxed px-4">
        ...
        <div className="flex justify-center mb-8 sm:mb-12">
          ...
          >
            <div className="w-24 h-24 sm:w-32 sm:h-32 md:w-40 md:h-40 rounded-full bg-gradient-to-br from-purple-500 to-pink-500 flex items-center justify-center shadow-2xl relative overflow-hidden">
              <div className="absolute inset-0 bg-gradient-to-tr from-purple-400/50 to-transparent animate-pulse"></div>
                ...
                <div className="group relative cursor-pointer h-40 sm:h-48 md:h-52">
                  <div className="relative h-full rounded-xl sm:rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
                    <div className="absolute inset-0">
                      ...
                      />
                      <div className="absolute inset-0 bg-gradient-to-br from-purple-500/70 to-pink-500/80 mix-blend-multiply"></div>
                    ...
                    <div className="absolute inset-0 rounded-xl sm:rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300"
                         style={{
                           boxShadow: "0 0 30px rgba(139,92,246,0.6), inset 0 0 20px rgba(236,72,153,0.3)"
                         }}
                    />
                  </div>
                </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6 md:gap-8 lg:gap-12 mb-10 sm:mb-12 md:mb-16 px-4">
          {badges.map((badge, index) => (
            <div
              ...
              style={{ transform: "translateY(30px)" }}
            >
              <div className="bg-white border-2 border-purple-200 rounded-xl sm:rounded-2xl px-6 sm:px-8 py-4 sm:py-6 shadow-lg hover:shadow-2xl hover:border-purple-500 transition-all duration-300 hover:scale-105 hover:-translate-y-1">
                <div className="flex items-center gap-3 sm:gap-4">
                  <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-full bg-gradient-to-br from-purple-500 to-pink-500 flex items-center justify-center shadow-md group-hover:scale-110 group-hover:rotate-12 transition-all duration-300">
                    <badge.icon className="text-white" size={20} />
                  </div>
                  <div>
                    <p className="text-2xl sm:text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-500 via-pink-400 to-blue-500">
                      {badge.value}
                    </p>
